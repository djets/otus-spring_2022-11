...
public class App {
    public static void main(String[] args) {
        ...
        printAllQuestionsAndAnswers(questionService, answerService, consoleOutput);
    }

    private static void printAllQuestionsAndAnswers(QuestionService questionService, AnswerService answerService, ConsoleOutputController consoleOutput) {
        answerService.getListObject()
                .stream()
                .peek(answer -> {
                    questionService.getListObject()
                            .forEach(question -> {
                ...
                .collect(Collectors.groupingBy(Answer::getQuestion, Collectors.toSet()))
                .forEach((k, v) -> {
